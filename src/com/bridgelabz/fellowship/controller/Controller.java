...
public class Controller {
	...
	public List<com.bridgelabz.fellowship.model.TransactionDetails> readFileTransaction() throws JsonParseException, JsonMappingException, IOException { // reading transaction details json file
		List<com.bridgelabz.fellowship.model.TransactionDetails> read = mapper.readValue(file3, new TypeReference<List<com.bridgelabz.fellowship.model.TransactionDetails>>() { //mapping data with file
		});
		return read; // returning list of transaction data
	}

	public void writeFileTransaction(List<com.bridgelabz.fellowship.model.TransactionDetails> list)
